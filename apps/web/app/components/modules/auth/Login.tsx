...
import useLoginWithEmail from '~/queries/auth/useLoginWithEmail';
...
const Login = () => {
  ...
  const handleGithubSignup = async () => await signupWithGitHub.mutateAsync();

  const handleGoogleSignup = async () => await signupWithGoogle.mutateAsync();
        ...
        <section className="flex h-dvh flex-col items-center justify-center">
          <Card className="w-full max-w-sm border border-card-border shadow-md hover:bg-card-background!">
            <Card.Section className="space-y-4 px-6 py-8">
              ...
              <h3 className="text-center font-semibold text-lg">Log in to your account</h3>
              <Divider />
              <ControlledTextInput
                name="email"
              ...
              <div className="flex flex-col gap-4">
                ...
                <Button
                  ...
                  disabled={signupWithGitHub.isPending || loginWithEmail.isPending}
                ...
                <Button
                  ...
                  disabled={signupWithGoogle.isPending || loginWithEmail.isPending}
          ...
          <div className="mt-4 text-center text-gray-500 text-sm">
            ...
            <Link to="/auth/signup" className="ml-1 text-primary-500 underline">
              Sign up
            </Link>
          </div>
        </section>
